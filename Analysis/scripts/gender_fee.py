...
OUTPUT_PATH = "../images/gender_vs_fee.png"
X_KEY = "Gender"
Y_KEY = "LnAuditfee_w"
X_LABEL = X_KEY
...
axes[0].bar(avg_fee_bign_1[X_KEY], avg_fee_bign_1[Y_KEY], color=BAR_COLORS)
axes[0].set_xlabel(X_LABEL)
axes[0].set_ylabel(Y_LABEL)
axes[0].set_title('Auditor Gender vs Average Fee (BigN auditing firms)')
axes[0].set_xticks(avg_fee_bign_1.index)
axes[0].set_xticklabels(BAR_LABELS)  # Modify the x-axis labels

# Plot the bar chart for BigN=0
axes[1].bar(avg_fee_bign_0[X_KEY], avg_fee_bign_0[Y_KEY], color=BAR_COLORS)
