# Nakul Nayak
# This script plots CFO consciousness score vs average fee
...
OUTPUT_PATH = "../images/cfo_consc_vs_fee.png"
X_KEY = "CFO_AveConsc"
Y_KEY = "LnAuditfee_w"
X_LABEL = "CFO Consciousness Score"
...
def plot():
    ...
    plt.xlabel(X_LABEL)
    plt.ylabel(Y_LABEL)
    plt.title('CFO Consciousness vs Average Fee')
