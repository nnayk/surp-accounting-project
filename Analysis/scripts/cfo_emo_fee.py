# Nakul Nayak
# This script plots CFO emotional stability score vs average fee
...
OUTPUT_PATH = "../images/cfo_emo_vs_fee.png"
X_KEY = "CFO_AveEmotiStability"
Y_KEY = "LnAuditfee_w"
X_LABEL = "CFO Emotional Stability Score"
...
def plot():
    ...
    plt.xlabel(X_LABEL)
    plt.ylabel(Y_LABEL)
    plt.title('CFO Emotional Stability vs Average Fee')
